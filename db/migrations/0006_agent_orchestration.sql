...
INSERT OR IGNORE INTO agent_registry (slug, display_name, description, enabled, schedule_label, current_status) VALUES
  ...
  ('portable-charging-lead-scout',
   'Portable Charging Lead Scout',
   'Finds venue leads for the portable-charging business, dedupes against existing rows, drafts outreach, and sends a review packet to the operator. Never sends outreach itself.',
   1, 'cron: daily', 'idle'),
  ('portable-charging-outreach-sender',
   'Portable Charging Outreach Sender',
   'After the operator approves drafts, sends the approved emails, checks bounces, and updates the spreadsheets. Idle until wired.',
   1, 'on approval', 'idle'),
