...
- MACHINE_SLOT_CONFIG: VTM Mini Wall, 8 selections, one slot each, 22mm coils, ~15 packs
  ...
  stays slot-level as specced. Machine 1 = Fixture Corner Store, Lexington MA.
- REFILL_CYCLE_DAYS = 30. Card-machine doctrine targets a monthly restock cycle (the
  ...
  law: expect Arjun to visit more often during cycle-one validation and to retune this
  after the first real velocity data.
