...
- Owner/runtime: Hermes Agent on the the VPS provider VPS
...
1. Translate Arjun's requests into concrete agent runs or build sessions.
...
5. Escalate blockers to Arjun instead of fabricating results.
...
- `AGENT_ORCHESTRATION_PROGRESS.md`
...
- Do not mutate cron schedules or external sending behavior without Arjun's explicit direction.
