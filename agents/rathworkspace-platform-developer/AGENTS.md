...
3. Run the nightly 11:45 PM ET developer-maintenance review: chats/workflows/build sessions, Obsidian vault hygiene, first-party repo hygiene, safe code cleanup, VPS health, and daily-memo inputs.
